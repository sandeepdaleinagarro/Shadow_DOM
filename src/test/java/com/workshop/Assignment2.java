...
public class Assignment2 {
	...
	public static void main(String[] args) {
		...
		SearchContext searchContext1 = (SearchContext) driver.executeScript("return arguments[0].shadowRoot", shadowHost1);
		
		System.out.println(searchContext1.findElement(By.cssSelector("#shadow_content")).getText());
